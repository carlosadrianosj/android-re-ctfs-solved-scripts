...
public class AlertDialogLayout extends ID {
    ...
    */
    public final void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
        ...
        L51:
            ...
            HD r7 = (defpackage.HD) r7
            int r8 = r7.gravity
            if (r8 >= 0) goto L74
            r8 = r3
        L74:
            java.util.WeakHashMap r9 = defpackage.AbstractC0725ab0.a
            int r9 = defpackage.La0.d(r10)
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) hd).width == -1) {
                        int i8 = ((LinearLayout.LayoutParams) hd).height;
                        ((LinearLayout.LayoutParams) hd).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) hd).height = i8;
                    }
                }
            }
        }
