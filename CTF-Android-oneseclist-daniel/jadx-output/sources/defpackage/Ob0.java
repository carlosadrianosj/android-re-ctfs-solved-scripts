...
public final class Ob0 {
    ...
    static {
        float[] fArr = AbstractC0139Fj.d;
        float fN = (float) ((AbstractC0139Fj.N() * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC0139Fj.b;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float fN2 = AbstractC0139Fj.N() / fArr[1];
        double d2 = fN2;
        ...
        k = new Ob0(fN2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public Ob0(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
