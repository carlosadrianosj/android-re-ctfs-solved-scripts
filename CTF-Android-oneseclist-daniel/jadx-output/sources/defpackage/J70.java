...
public final class J70 {
    ...
    public /* synthetic */ J70(double d, double d2, double d3, double d4, double d5) {
    ...
    public final boolean equals(Object obj) {
        ...
        J70 j70 = (J70) obj;
        return Double.compare(this.a, j70.a) == 0 && Double.compare(this.b, j70.b) == 0 && Double.compare(this.c, j70.c) == 0 && Double.compare(this.d, j70.d) == 0 && Double.compare(this.e, j70.e) == 0 && Double.compare(this.f, j70.f) == 0 && Double.compare(this.g, j70.g) == 0;
    }
    ...
    public J70(double d, double d2, double d3, double d4, double d5, double d6, double d7) {
        this.a = d;
        this.b = d2;
        this.c = d3;
        this.d = d4;
