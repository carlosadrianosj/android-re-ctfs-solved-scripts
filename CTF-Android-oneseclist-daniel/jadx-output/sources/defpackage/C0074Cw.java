...
public final class C0074Cw {
    public final SharedPreferences a;

    public C0074Cw(Context context, String str) {
        ...
        try {
            ...
            for (Map.Entry<String, ?> entry : this.a.getAll().entrySet()) {
                if (entry.getValue() instanceof Set) {
                    ...
                    if (!hashSet.isEmpty()) {
                        arrayList.add(new C1782oa(entry.getKey(), new ArrayList(hashSet)));
                    }
                }
            }
    ...
    public final synchronized void g(long j, String str) {
        String strD = d(j);
        if (this.a.getString("last-used-date", BuildConfig.VERSION_NAME).equals(strD)) {
            String strE = e(strD);
            if (strE == null) {
                return;
            }
