...
public final class Y0 implements InterfaceMenuItemC2046s30 {
    ...
    public Y0(Context context, CharSequence charSequence) {
        this.i = context;
        this.a = charSequence;
    }
    ...
    public final void c() {
        ...
        if (drawable != null) {
            if (this.n || this.o) {
                ...
                if (this.o) {
                    AbstractC0248Jo.i(this.h, this.m);
                }
            }
        }
    }
    ...
    public final MenuItem setIcon(int i) {
        this.h = AbstractC1489ki.b(this.i, i);
        c();
        return this;
    }
