...
public final class WG extends AppCompatCheckBox {
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.o == null) {
            ...
            int iF2 = AbstractC2591zA.F(this, androidx.test.annotation.R.attr.colorSurface);
            int iF3 = AbstractC2591zA.F(this, androidx.test.annotation.R.attr.colorOnSurface);
            this.o = new ColorStateList(q, new int[]{AbstractC2591zA.K(1.0f, iF2, iF), AbstractC2591zA.K(0.54f, iF2, iF3), AbstractC2591zA.K(0.38f, iF2, iF3), AbstractC2591zA.K(0.38f, iF2, iF3)});
        }
        return this.o;
    }
