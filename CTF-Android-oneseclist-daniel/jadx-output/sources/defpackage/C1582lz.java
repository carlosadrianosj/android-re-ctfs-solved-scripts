...
public final class C1582lz extends WZ {
    public final /* synthetic */ C1734nz d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1582lz(C1734nz c1734nz, OneListDatabase oneListDatabase) {
    ...
    public final String a() {
        return "INSERT INTO `itemList` (`title`,`position`,`items`,`uri`,`id`) VALUES (?,?,?,?,nullif(?, 0))";
    }
